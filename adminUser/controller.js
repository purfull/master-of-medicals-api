...
const createAdminUser = async (req, res) => {
  const { name, email, phone, password, address, city, state, country, postalCode, role, status } = req.body;
  ...
  try {
    ...
    const newAdmin = await AdminUser.create({
      name, email, phone, password: hashedPassword, address, city, state, country, postalCode, profile: filePaths, role, status
    });
...
const updateAdminUser = async (req, res) => {
    const { id, name, email, phone, address, city, state, country, postalCode, role, status } = req.body;
    ...
    try {
      ...
      await AdminUser.update(
        { name, email, phone, profile: imagePaths, address, city, state, country, postalCode, role, status },
        { where: { id } }
      );
